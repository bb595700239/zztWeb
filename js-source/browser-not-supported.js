...
if(window.attachEvent){
  window.attachEvent('onload', function(){
    ...
    el.innerHTML =	'尊敬的中政投用户：<br />'+
        '使用此平台需要安装Internet Explorer更新版本的浏览器，'+
        ...
        '也可以在其他浏览器，'+
        '如<a href="http://se.360.cn/" style="'+linkStyle+'" target="_blank">360安全浏览器</a>'+
        '或<a href="http://www.firefox.com.cn/download/" style="'+linkStyle+'" target="_blank">Firefox</a>火狐中打开平台。';
    // elStyle.width = '100%';
    elStyle.width = '720px';
    elStyle.color = '#000';
