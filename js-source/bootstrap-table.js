...
!function ($) {
    ...
    BootstrapTable.LOCALES['zh-CN'] = BootstrapTable.LOCALES['zh'] = {
        ...
        formatShowingRows: function (pageFrom, pageTo, totalRows) {
            return '第 ' + pageFrom + ' - ' + pageTo + ' 条，总共 ' + totalRows + ' 条记录';
        },
    ...
    BootstrapTable.prototype.initServer = function (silent, query) {
        ...
        request = $.extend({}, calculateObjectValue(null, this.options.ajaxOptions), {
            ...
            success: function (res) {
                ...
                if (!silent) {that.$tableLoading.hide();that.$el.show()}
                $.customtitle()
            },
            error: function (res) {
...
function queryParams(params) {//表格请求参数初始化
    var obj1=$("form").serializeArray(),obj2={limit:params.limit,offset:params.offset},obj3={};
    $.each(obj1,function(index){ 
    if(obj3[this['name']]){ 
            obj3[this['name']] = obj3[this['name']]+","+this['value']; 
        }else{ 
            obj3[this['name']] = this['value']; 
        } 
    }); 
    return $.extend(obj2,obj3);
}